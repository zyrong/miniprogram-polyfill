...
if (typeof Symbol !== 'undefined' && Symbol.toStringTag) {
  Object.defineProperty(TextEncoderPolyfill.prototype, Symbol.toStringTag, {
    value: 'TextEncoder',
  })
}

const existTextEncoder = typeof TextEncoder !== 'undefined'
if (existTextEncoder && !TextEncoder.prototype.encodeInto) {
  ...
  TextEncoder.prototype.encodeInto = function (
    ...
    return TextEncoderPolyfill.prototype.encodeInto(string, u8arr)
  }
}

export default existTextEncoder ? TextEncoder : TextEncoderPolyfill
